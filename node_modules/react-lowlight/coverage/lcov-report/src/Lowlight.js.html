...
<html lang="en">
<head>
    <title>Code coverage report for src/Lowlight.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Lowlight.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  var codeProps = result.language
    ...
    : {className: 'hljs'}
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (props.inline) {
<span class="cstat-no" title="statement not covered" >    codeProps.style = {display: 'inline'}</span>
  }
&nbsp;
...
&nbsp;
  ...
  return props.inline ? <span class="branch-0 cbranch-no" title="branch not covered" >code </span>: h('pre', {className: props.className}, code)
}
&nbsp;
Lowlight.propTypes = {
...
&nbsp;
Lowlight.hasLanguage = <span class="fstat-no" title="function not covered" >function (lang) {</span>
<span class="cstat-no" title="statement not covered" >  return !!low.getLanguage(lang)</span>
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jun 28 2017 10:47:02 GMT+0200 (CEST)
</div>
</div>
